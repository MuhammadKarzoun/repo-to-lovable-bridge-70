...
import { IAttachment, IConditionsRule } from "@octobots/ui/src/types";
import { ILeadData, ILeadIntegration } from "@octobots/ui-leads/src/types";
...
import ConditionsRule from "@octobots/ui/src/components/rule/ConditionsRule";
import { Content } from "@octobots/ui-inbox/src/settings/integrations/styles";
import { ControlWrapper } from "@octobots/ui/src/components/step/styles";
import { IConfig } from "@octobots/ui-settings/src/general/types";
import { IField } from "@octobots/ui/src/types";
import { IFormData } from "@octobots/ui-forms/src/forms/types";
import { Indicator } from "@octobots/ui/src/components/step/styles";
import { LeftContent } from "@octobots/ui-inbox/src/settings/integrations/styles";
import { Link } from "react-router-dom";
import { PreviewWrapper } from "@octobots/ui/src/components/step/style";
import React from "react";
import { SmallLoader } from "@octobots/ui/src/components/ButtonMutate";
import { StepWrapper } from "@octobots/ui/src/components/step/styles";
      ...
      <StepWrapper>
        ...
        <LeftContent style={{
            ...
            <Steps direction="horizontal" >
              ...
              <Step
                img="/images/icons/octobots-03.svg"
                title="CallOut"
                onClick={this.onStepClick}
              >
                <CallOut
              ...
              <Step
                img="/images/icons/octobots-12.svg"
                title={"Content"}
                onClick={this.onStepClick}
              >
                <FormStep
              ...
              <Step
                img="/images/icons/octobots-02.svg"
                title="Rule"
                onClick={this.onStepClick}
              >
              ...
              <Step
                img="/images/icons/octobots-06.svg"
                title="Options"
                onClick={this.onStepClick}
              >
                <OptionStep
              ...
              <Step
                img="/images/icons/octobots-05.svg"
              ...
              <Step
                img="/images/icons/octobots-13.svg"
                title="Confirmation"
                onClick={this.onStepClick}
                noButton={true}
              >
