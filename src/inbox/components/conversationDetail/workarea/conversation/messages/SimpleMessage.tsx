...
const SimpleMessage: React.FC<Props> = React.memo(
  ({
    ...
    const renderReplyContent = useCallback(() => {
      ...
      const hasAttachment =
        message.replyForMsg.attachments &&
        message.replyForMsg.attachments.length > 0;
        ...
        <>
          <span
            dangerouslySetInnerHTML={{
              __html: xss(urlify(message.replyForMsg.content)),
            }}
          />
          {renderAttachment()}
        </>
          ...
          >
            ...
            <MenuItem>
              <a className="dropdown-item">
                ...
                <CopyToClipboard
                  text={strip(message.content)}
                  onCopy={() => Alert.success("Message copied!")}
                >
            ...
            <MenuItem>
              <a
                ...
                onClick={() =>
                  confirm().then(() =>
                    updateMsg(message._id, { hideMsg: true }, "delete")
                  )
                }
              >
            ...
            <MenuItem>
              <a className="dropdown-item">
                ...
                <CopyToClipboard
                  text={getMsgURL()}
                  onCopy={() => Alert.success("Highlight link copied!")}
                >
    ...
    const renderMessageReaction = () => {
      ...
      return (
        <ReactionContainer>
          <ReactionEmoji
            onClick={() => updateMsg(message._id, { reaction: "" }, "reaction")}
          >
            {message.reaction}
          </ReactionEmoji>
        </ReactionContainer>
