...
import { AvatarImg } from '@octobots/ui/src/components/filterableList/styles';
...
import { PopoverButton } from '@octobots/ui-inbox/src/inbox/styles';
  ...
  render() {
    ...
    const actionBarLeft = (
      <ActionBarLeft>
        ...
        {(kind === 'facebook-messenger' || kind == 'whatsapp' || kind === 'instagram-messenger') && (
          <>
            {readUsers &&
