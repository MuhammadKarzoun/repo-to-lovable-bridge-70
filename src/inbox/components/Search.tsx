...
import { EmptyState, Icon, Spinner } from '@octobots/ui/src/components';
import { borderRadius, spacing, typography } from '../../styles/theme';
import { rtl } from '@octobots/ui/src/utils/rtl';

const MainContainer = styledTS<{ $active?: boolean }>(styled.div)`
  margin: ${spacing.md} 0;
  width: 100%;
  background-color: ${(props) =>
    props.$active ? colors.colorWhite : colors.bgActive};
  border: 1px solid ${(props) =>
    props.$active ? colors.borderDarker : colors.bgActive};
...
const Results = styled.div`
  ...
  overflow-x: auto;
  z-index: 99;
  ${rtl(`inset-inline-start:`, 'inset-inline-end:')} 0;
  top: 36px;
