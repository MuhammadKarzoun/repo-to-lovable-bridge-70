...
const Tab = styled.div<{ $active: boolean }>`
  ...
  font-weight: ${props => props.$active ? typography.fontWeights.semibold : typography.fontWeights.normal};
...
const TabFilter: React.FC<TabFilterProps> = ({ queryParams, currentUser, counts }) => {
