...
import { LogoContainer } from '@octobots/ui-settings/src/styles';
...
const OctobotsTopbar = styled.div`
  background-image: url(https://s3.amazonaws.com/octobots/pattern.png);
...
const TopBarIcon = styledTS<{ $isLeft: boolean }>(styled.div)`
  ...
  position: absolute;
  top: 7px;
  inset-inline-start: ${props => props.$isLeft && '15px'};
  inset-inline-end: ${props => (props.$isLeft ? '0px' : '15px')};
...
const OctobotsMiddleTitle = styled.div`
  ...
  h3 {
    ...
    padding-inline-end: ${dimensions.headerSpacing}px;
    line-height: 1.5;
  }
...
const OctobotsStaffProfile = styled.div`
  width: 33%;
...
const OctobotsSupporters = styled.div`
...
const Supporters = styled(OctobotsSupporters)`
...
const OctobotsState = styled.div`
  font-size: ${typography.fontSizeUppercase}px;
  font-weight: ${typography.fontWeightLight};
  margin-inline-start	: 43px;
`;

const OctobotsSpacialMessage = styled.li`
  border-radius: ${unitSpace};
...
const OctobotsAvatar = styled.div`
  border-radius: 50%;
  bottom: ${coreSpace};
  width: 40px;
  height: 40px;
...
const OctobotsMessagesList = styled.ul`
...
const OctobotsMessage = styled.div`
...
const OctobotsDate = styled.div`
  font-size: ${unitSpace};
  color: ${colors.colorCoreGray};
  margin-inline-start	: ${dimensions.headerSpacing}px;
`;

const OctobotsMessageSender = styled.div`
  overflow: hidden;
  font-size: 14px;
...
const OctobotsGreeting = styled.div`
...
const OctobotsFromCustomer = styled.li`
  text-align: end;
`;
...
const FromCustomer = styled(OctobotsMessage)`
  border-end-start-radius: ${coreSpace};
...
const Socials = styled.div`
  margin-inline-end: ${dimensions.coreSpacing}px;
...
const OctobotsContent = styledTS<{ $isTabbed: boolean }>(styled.div)`
  height: 100%;
