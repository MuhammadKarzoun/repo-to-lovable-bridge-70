...
import { NotWrappable } from "@octobots/ui-settings/src/permissions/styles";
...
function Skills(props: Props) {
  ...
  function renderActionBar() {
    const trigger = (
      <Button id="skill-new-skill" btnStyle="warning" icon="plus-circle">
        {__("New skill")}
      </Button>
    );
  ...
  return (
    <Wrapper
      ...
      //     title={"All Skills"}
      //     description={`${__(
      //       "The skills feature works with the octobots Messenger and the Team Inbox"
      //     )}.${__(
      ...
      //     )}.${__(
      //       "As for the customers, they will see the option to choose from when interacting with you through the octobots Messenger"
